  ...
  try {
    ...
    const services = [
      ...
      },
      {
        ...
        title_ar: 'النقل البري',
        title_ro: 'Transport Terestru',
      ...
      },
      {
        ...
        title_ar: 'الاستيراد والتصدير',
        title_ro: 'Import & Export',
      ...
      {
        title_en: 'Security Solutions',
        title_ar: 'حلول الأمان',
        title_ro: 'Soluții de Securitate',
