          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3 rtl:space-x-reverse">
                ...
                <span className="text-blue-100">{siteSettings?.address || 'București, România'}</span>
              </div>
              <div className="flex items-center space-x-3 rtl:space-x-reverse">
                <span className="text-blue-300">✉️</span>
                <a href={`mailto:${siteSettings?.contactEmail || 'info@blacksea-star.com'}`} className="text-blue-100 hover:text-white transition-colors">{siteSettings?.contactEmail || 'info@blacksea-star.com'}</a>
              </div>
              <div className="flex items-center space-x-3 rtl:space-x-reverse">
                <span className="text-blue-300">🌐</span>
                <a href={`https://${siteSettings?.website || 'www.blacksea-star.com'}`} target="_blank" rel="noopener noreferrer" className="text-blue-100 hover:text-white transition-colors">{siteSettings?.website || 'www.blacksea-star.com'}</a>
              </div>
              <div className="flex items-center space-x-3 rtl:space-x-reverse">
                <span className="text-blue-300">📞</span>
                <a href={`tel:${siteSettings?.contactPhone || '+40726547699'}`} className="text-blue-100 hover:text-white transition-colors">{siteSettings?.contactPhone || '+40 726 547 699'}</a>
              </div>
              <div className="flex items-center space-x-3 rtl:space-x-reverse">
                <span className="text-blue-300">📱</span>
                <a href={`tel:${siteSettings?.contactPhone2 || '+40791391711'}`} className="text-blue-100 hover:text-white transition-colors">{siteSettings?.contactPhone2 || '+40 791 391 711'}</a>
              </div>
            </div>
